...
Revision ID: e04b0d1d420d
Revises: 
Create Date: 2018-09-25 21:29:23.219615
...
def upgrade():
    ...
    sa.Column('hotel', sa.String(length=64), nullable=True),
    ...
    sa.Column('slika_URL', sa.String(length=255), nullable=True),
    sa.Column('lajkovi', sa.Integer(), nullable=True),
    sa.Column('omiljeno', sa.Integer(), nullable=True),
    ...
    sa.Column('dat_pol', sa.String(length=64), nullable=True),
    sa.Column('dat_dol', sa.String(length=64), nullable=True),
    sa.ForeignKeyConstraint(['id_destinacija'], ['destinacija.id'], ondelete='CASCADE'),
